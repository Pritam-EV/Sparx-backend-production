...
//   OWNER bears  : wheeling, demand, FAC, fixed, duty, meter rent,
//                  power factor penalty, delayed payment, regulatory, other
...
const ElectricityBillSchema = new mongoose.Schema(
  {
    ...
    charges: {
      ...
      // ── Owner-bearing (fixed / infrastructure charges) ────────────────
...
extraCharges: [
  {
    ...
    // Full EB total = energyCharges + totalOwnerPayable
